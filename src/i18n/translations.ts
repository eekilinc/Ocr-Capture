...
export const translations = {
  tr: {
    ...
    formatTable: "Tablo (Excel TSV)",
    formatMarkdownTable: "Tablo (Markdown)",
    btnSearchWeb: "Google'da Ara",
    btnFindReplace: "Bul & Değiştir",
    replaceWith: "İle değiştir...",
    btnReplace: "Değiştir",
    btnReplaceAll: "Tümünü Değiştir",
    delayTimer: "Gecikme",
    delaySeconds: "sn",
    countdownText: "Yakalama başlıyor:",
    cancelCountdown: "İptal: ESC",
    btnStop: "Durdur",
    btnSpeak: "Sesli Oku",
    btnCopy: "Kopyala",
  ...
  en: {
    ...
    formatTable: "Table (Excel TSV)",
    formatMarkdownTable: "Table (Markdown)",
    btnSearchWeb: "Search with Google",
    btnFindReplace: "Find & Replace",
    replaceWith: "Replace with...",
    btnReplace: "Replace",
    btnReplaceAll: "Replace All",
    delayTimer: "Delay",
    delaySeconds: "s",
    countdownText: "Capturing in:",
    cancelCountdown: "ESC to cancel",
    btnStop: "Stop",
    btnSpeak: "Read Aloud",
    btnCopy: "Copy",
    btnCopied: "Copied!",
